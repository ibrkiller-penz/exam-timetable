...
export const AppShell: React.FC<AppShellProps> = ({ currentTab, onTabChange, children }) => {
  ...
  const steps = [
    ...
    { id: 'step7', num: 7, label: '7. 학생배치', icon: Grid, done: !!(stages.step7 ?? stages.stage4) },
    { id: 'step8', num: 8, label: '8. 응시현황', icon: ClipboardList, done: !!(stages.step8 ?? stages.stage5) },
  ];
