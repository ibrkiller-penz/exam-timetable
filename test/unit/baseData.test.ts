...
describe('baseData', () => {
  it('correctly calculates vbaVal', async () => {
  ...
  it('builds subject tables and rooms', async () => {
  ...
  it('handles convenience class move', async () => {
    let rows = (await parseNeisFile(makeNeisWorkbook(makeNeisRows()))).rows;
